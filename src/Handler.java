...
public class Handler {
	...
	public static void createProcess(Process process) throws IOException {
		// check if there is place in the memory
		...
		if (spaceForMe()) {
			...
			// choose which process to remove : 1- check if a process is finished. 2- check
			// if a process is blocked 3- remove any one (the first)
	...
	// function that puts the process into memory for the first time (from the
	// program.txt)
	public static PCB loadProcesstoMemory(String path) throws IOException {
		...
		PCB pcb = new PCB(State.READY, pcbID, start, start + 19); // not sure of end

		
		// ------------------------ Important note
		// ----------------------------------------
		// i changed the order of how a process is stored in memory
		// first pcb attributs then 3 variables then the instructions
		//pcbID++;
		...
		// TODO: figure out how these variables work
	...
	// functions to swap between memory and hardDisk by taking start index of
	// process
		...
		for (int n = index; n <= (index + 19); n++) {
			if (i < diskContents.size()) {
				if (i == 0) { // pcb state
					...
					// TODO: Should we update the memory start and memory end of the
					// pcb???????????????
	...
	// returns true if the instruction is executed succesfully and false if it is
	// not succesful
	public static boolean execute(String instruction, Process process) throws IOException {
		...
		case "assign": {
			// TODO : assign a readfile b case
			// check if requires 2 clocks --> in first don't increment pc and excute the
			// read/input
			// in second increment pc and excute the assign
			// problem1: where to store the read value between the cycles
			// problem2: how to know if it is first or second
			Variable v;
	...
	public static void main(String[] args) throws IOException {
		...
		Process process1 = new Process("Program_1.txt", 2);
		Process process2 = new Process("Program_2.txt", 0);
		Process process3 = new Process("Program_3.txt", 4);
		hand.scheduler = new Scheduler(6, process1, process2, process3);
		hand.scheduler.roundRobin();
//		hand.createProcess(process1);
//		hand.createProcess(process2);
//		hand.createProcess(process3);

//		for (Object o : hand.memory) {
...
//
//		hand.swapMemoryAndDisk(20);
//		for (Object o : hand.memory) {
//			System.out.println(o);
//		}
//		System.out.println("------4---------------");
//
//		Scheduler s = hand.scheduler;
//		System.out.println("PCBs for Round Robin");
//		for (int i : s.processId) {
//			System.out.print(i + ", ");
//		}
//		System.out.println();
//		System.out.println("ArrivalTimes for Round Robin");
//		for (int i : s.arrivalTime) {
//			System.out.print(i + ", ");
//		}
//		System.out.println();
//		System.out.println("BurstTimes for Round Robin");
//		for (int i : s.burstTime) {
//			System.out.print(i + ", ");
//		}
//		System.out.println();
//		
